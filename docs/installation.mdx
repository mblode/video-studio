...
| `ARK_API_KEY` | BytePlus Seedance 2.x / `dreamina-*` ids ([BytePlus console](https://console.byteplus.com)) |
| `MINIMAX_API_KEY` | Films whose `film.model` is MiniMax-H3 |
| `GEMINI_API_KEY` | Nano Banana stills, `vs score` (Lyria), and `vs narrate` (Gemini 3.8 TTS) |
